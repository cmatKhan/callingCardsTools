...
from callingcardstools import HopsDb
...
class WithBackground(HopsDb):
    """This extends HopsDb with functions to call significant peaks on mammals data using a MACS-like background free algorithm"""
